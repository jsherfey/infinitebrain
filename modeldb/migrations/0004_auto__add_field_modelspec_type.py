...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ModelSpec.type'
        db.add_column(u'modeldb_modelspec', 'type',
                      self.gf('django.db.models.fields.CharField')(default='dsim', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ModelSpec.type'
        db.delete_column(u'modeldb_modelspec', 'type')
